  ...
  <div>
    <div class="page-header page-header-small">
      ...
      <div class="content-center">
        <div class="container">
          <h1 class="title">eServices Cluster</h1>
        </div>
      </div>
    </div>
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="team-player">
                ...
                />
                <h4 class="title">John Arvin Enriquez</h4>
                <p class="category text-primary">VP for eServices</p>
                <p class="description">
            ...
            <div class="col-md-4">
              <div class="team-player">
                <img
                  ...
                  class="rounded-circle img-fluid img-raised"
                />
                <h4 class="title">Miggy Pinaroc</h4>
                <p class="category text-primary">AVP for Systems Documentations</p>
                <p class="description">
                  You can write here details about one of your team members. You
                  can give more details about what they do. Feel free to add
                  some <a href="#">links</a> for people to be able to follow
            ...
            <div class="col-md-4">
              <div class="team-player">
                <img
                  ...
                  class="rounded-circle img-fluid img-raised"
                />
                <h4 class="title">Paolo Laxamana</h4>
                <p class="category text-primary">AVP for IT Services</p>
                <p class="description">
                  You can write here details about one of your team members. You
                  can give more details about what they do. Feel free to add
                  some <a href="#">links</a> for people to be able to follow
            ...
            <div class="col-md-4">
              <div class="team-player">
                <img
                  ...
                  class="rounded-circle img-fluid img-raised"
                />
                <h4 class="title">Renzo Timothy Tan</h4>
                <p class="category text-primary">AVP for IT Skills Training</p>
                <p class="description">
                  You can write here details about one of your team members. You
                  can give more details about what they do. Feel free to add
                  some <a href="#">links</a> for people to be able to follow
            ...
            <div class="col-md-4">
              <div class="team-player">
                <img
                  ...
                  class="rounded-circle img-fluid img-raised"
                />
                <h4 class="title">Sophia Jarobel</h4>
                <p class="category text-primary">OSG Associate for eServices</p>
                <p class="description">
                  You can write here details about one of your team members. You
                  can give more details about what they do. Feel free to add
                  some <a href="#">links</a> for people to be able to follow
